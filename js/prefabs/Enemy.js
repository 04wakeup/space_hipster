...
//    this.game.physics.arcade.enable(this);
    ...
    this.animations.add('getHit', [0, 1, 2, 1, 0], 25, false);  // repetition is false, 25 is execute this animation time???
...
SpaceHipster.Enemy.prototype.damage = function(amount){
    ...
    // particle explosion
    if(this.health <= 0){
        var emitter = this.game.add.emitter(this.x, this.y, 100);  // release 100%
        emitter.makeParticles('enemyParticle');
        emitter.minParticleSpeed.setTo(-200, -200);  // x , y scope
